...
if (strpos($string, $substring) !== false) {
    ...
    // echo $encoded_string;
    echo '<iframe width="100%" height="100%" src="https://lookerstudio.google.com/embed/reporting/8a0cfbfe-f1e0-40fe-816a-9de55d62d0aa/page/jc7aF" frameborder="0" style="border:0" allowfullscreen sandbox="allow-storage-access-by-user-activation allow-scripts allow-same-origin allow-popups allow-popups-to-escape-sandbox"></iframe>';
} else {
